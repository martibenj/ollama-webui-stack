...
`qwen2.5:7b` performs noticeably in conversations. \
...
eg for Windows in a admin powershell, `{40E0AC32-46A5-438A-A0B2-2B479E8F2E90}` is the WSL id by Microsoft:
```bash
